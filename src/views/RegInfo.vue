  ...
  <v-container class="">
    <v-row justify="center">
      ...
      >
        ...
        <div class="px-16"><router-link class="text-h4" to="/hoinfo">호출정보</router-link></div>
        <div><router-link class="text-h4 font-weight-bold" to="/reginfo">Registered정보<span class="spans"></span></router-link></div>
      </v-col>
      <v-col cols="12">
